...
public class GuiAdvancementTab extends Gui
{
    ...
    public void func_192991_a(int p_192991_1_, int p_192991_2_, int p_192991_3_, int p_192991_4_)
    {
        ...
        drawRect(0, 0, 234, 113, MathHelper.floor_float(this.field_191815_r * 255.0F) << 24);
        boolean flag = false;
        ...
        if (flag)
        {
            this.field_191815_r = MathHelper.clamp_float(this.field_191815_r + 0.02F, 0.0F, 0.3F);
        }
        else
        {
            this.field_191815_r = MathHelper.clamp_float(this.field_191815_r - 0.04F, 0.0F, 1.0F);
        }
    }
    ...
    public void func_191797_b(int p_191797_1_, int p_191797_2_)
    {
        ...
        {
            this.field_191811_n = MathHelper.clamp_int(this.field_191811_n + p_191797_1_, -(this.field_191813_p - 234), 0);
        }

        if (this.field_191814_q - this.field_193940_r > 113)
        {
            this.field_191812_o = MathHelper.clamp_int(this.field_191812_o + p_191797_2_, -(this.field_191814_q - 113), 0);
        }
    }
