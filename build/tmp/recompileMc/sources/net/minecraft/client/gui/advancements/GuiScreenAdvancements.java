...
public class GuiScreenAdvancements extends GuiScreen implements ClientAdvancementManager.IListener
{
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            ...
            {
                if (guiadvancementtab.getPage() == tabPage && guiadvancementtab.func_191793_c(i, j, mouseX, mouseY))
                {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (maxPages != 0)
        {
            ...
            this.fontRendererObj.drawStringWithShadow(page, i + (252 / 2) - (width / 2), j - 44, -1);
        }
