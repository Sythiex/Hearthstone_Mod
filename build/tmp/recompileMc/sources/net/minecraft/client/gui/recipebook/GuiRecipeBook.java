...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener
{
    ...
    public void func_194303_a(int p_194303_1_, int p_194303_2_, Minecraft p_194303_3_, boolean p_194303_4_, InventoryCrafting p_194303_5_)
    {
        ...
        this.field_193964_s = p_194303_3_.thePlayer.func_192035_E();
        this.field_193966_v = p_194303_3_.thePlayer.inventory.func_194015_p();
    ...
    public void func_193014_a(boolean p_193014_1_, InventoryCrafting p_193014_2_)
    {
        ...
        this.field_191888_F.thePlayer.inventory.func_194016_a(this.field_193965_u, false);
    ...
    public void func_193957_d()
    {
        if (this.func_191878_b())
        {
            if (this.field_193966_v != this.field_191888_F.thePlayer.inventory.func_194015_p())
            {
                this.func_193942_g();
                this.field_193966_v = this.field_191888_F.thePlayer.inventory.func_194015_p();
            }
        }
    }
    ...
    {
        if (this.func_191878_b() && !this.field_191888_F.thePlayer.isSpectator())
        {
            if (this.field_193022_s.func_194196_a(p_191862_1_, p_191862_2_, p_191862_3_, (this.field_191904_o - 147) / 2 - this.field_191903_n, (this.field_191905_p - 166) / 2, 147, 166))
            {
                ...
                if (irecipe != null && recipelist != null)
                {
                    ...
                    this.field_191915_z.func_192682_a();
                    this.field_191888_F.playerController.func_194338_a(this.field_191888_F.thePlayer.openContainer.windowId, irecipe, GuiScreen.isShiftKeyDown(), this.field_191888_F.thePlayer);
    ...
    public void func_193001_a(List<IRecipe> p_193001_1_)
    {
        ...
        {
            this.field_191888_F.thePlayer.func_193103_a(irecipe);
        }
    }
