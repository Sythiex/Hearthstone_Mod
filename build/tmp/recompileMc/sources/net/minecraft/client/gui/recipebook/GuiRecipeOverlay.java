...
public class GuiRecipeOverlay extends Gui
{
    ...
    public void func_191845_a(Minecraft p_191845_1_, RecipeList p_191845_2_, int p_191845_3_, int p_191845_4_, int p_191845_5_, int p_191845_6_, float p_191845_7_, RecipeBook p_191845_8_)
    {
        ...
        if (f2 > f3)
        {
            this.field_191852_j = (int)((float)this.field_191852_j - p_191845_7_ * (float)MathHelper.ceiling_float_int((f2 - f3) / p_191845_7_));
        }
        ...
        if (f4 < f5)
        {
            this.field_191852_j = (int)((float)this.field_191852_j - p_191845_7_ * (float)MathHelper.ceiling_float_int((f4 - f5) / p_191845_7_));
        }
    ...
    public void func_191842_a(int p_191842_1_, int p_191842_2_, float p_191842_3_)
    {
        if (this.field_191850_h)
        {
            ...
            int k = MathHelper.ceiling_float_int((float)this.field_193972_f.size() / (float)i);
            int l = 24;
            int i1 = 4;
            int j1 = 82;
            int k1 = 208;
                ...
                for (int k1 = 0; k1 < k; ++k1)
                {
                    if (iterator.hasNext())
                    {
                        ...
                        if (aitemstack.length != 0)
                        {
                            ...
                            p_191745_1_.getRenderItem().renderItemAndEffectIntoGUI(aitemstack[MathHelper.floor_float(GuiRecipeOverlay.this.field_193974_m / 30.0F) % aitemstack.length], i2, j2);
