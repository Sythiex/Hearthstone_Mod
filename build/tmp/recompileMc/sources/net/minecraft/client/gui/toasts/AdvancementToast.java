    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_)
    {
        ...
        if (displayinfo != null)
        {
            ...
            else
            {
                ...
                {
                    int k = MathHelper.floor_float(MathHelper.clamp_float((float)(1500L - p_193653_2_) / 300.0F, 0.0F, 1.0F) * 255.0F) << 24 | 67108864;
                ...
                {
                    int i1 = MathHelper.floor_float(MathHelper.clamp_float((float)(p_193653_2_ - 1500L) / 300.0F, 0.0F, 1.0F) * 252.0F) << 24 | 67108864;
