...
public class EntityRenderer implements IResourceManagerReloadListener
{
        ...
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (world != null)
            {
                ...
                for (int i = 0; i < 256; ++i)
                {
                    ...
                    // Forge: fix MC-58177
                    f8 = MathHelper.clamp_float(f8, 0f, 1f);
                    f9 = MathHelper.clamp_float(f9, 0f, 1f);
                    f10 = MathHelper.clamp_float(f10, 0f, 1f);
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                try
                {
                    net.minecraftforge.client.ForgeHooksClient.drawScreen(this.mc.currentScreen, k1, l1, this.mc.func_193989_ak());
                }
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        else
        {
            ...
            IBlockState viewportState = this.mc.theWorld.getBlockState(viewportPos);
            Vec3d inMaterialColor = viewportState.getBlock().getFogColor(this.mc.theWorld, viewportPos, viewportState, entity, new Vec3d(fogColorRed, fogColorGreen, fogColorBlue), partialTicks);
