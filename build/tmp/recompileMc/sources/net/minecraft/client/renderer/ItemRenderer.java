...
public class ItemRenderer
{
    ...
    private void renderMapFirstPerson(ItemStack stack)
    {
        ...
        tessellator.draw();
        MapData mapdata = ((net.minecraft.item.ItemMap) stack.getItem()).getMapData(stack, this.mc.theWorld);
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        if (abstractclientplayer.isHandActive())
        {
            ...
            if (!itemstack.func_190926_b() && itemstack.getItem() == Items.BOW) //Forge: Data watcher can desync and cause this to NPE...
            {
    ...
    private void renderWaterOverlayTexture(float partialTicks)
    {
        ...
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        float f = this.mc.thePlayer.getBrightness();
    ...
    public void updateEquippedItem()
    {
        ...
        else
        {
            ...
            this.equippedProgressMainHand += MathHelper.clamp_float((!requipM ? f * f * f : 0.0F) - this.equippedProgressMainHand, -0.4F, 0.4F);
            this.equippedProgressOffHand += MathHelper.clamp_float((float)(!requipO ? 1 : 0) - this.equippedProgressOffHand, -0.4F, 0.4F);
        }
