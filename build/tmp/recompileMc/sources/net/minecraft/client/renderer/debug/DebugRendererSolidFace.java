...
public class DebugRendererSolidFace implements DebugRenderer.IDebugRenderer
{
    ...
    {
        EntityPlayer entityplayer = this.field_193851_a.thePlayer;
        ...
        World world = this.field_193851_a.thePlayer.worldObj;
        Iterable<BlockPos> iterable = BlockPos.func_191532_a(MathHelper.floor_double(entityplayer.posX - 6.0D), MathHelper.floor_double(entityplayer.posY - 6.0D), MathHelper.floor_double(entityplayer.posZ - 6.0D), MathHelper.floor_double(entityplayer.posX + 6.0D), MathHelper.floor_double(entityplayer.posY + 6.0D), MathHelper.floor_double(entityplayer.posZ + 6.0D));
