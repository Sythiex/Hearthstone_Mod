...
public class EntitySelector
{
                    ...
                    if (world != null)
                    {
                        ...
                        if ("s".equalsIgnoreCase(s))
                        {
                            ...
                            if (entity != null && targetClass.isAssignableFrom(entity.getClass()))
                            {
                                ...
                                {
                                    int i = parseIntWithDefault(map, field_190838_l, 0);
                                    int j = parseIntWithDefault(map, field_190839_m, 0);
                                    int k = parseIntWithDefault(map, field_190840_n, 0);
    ...
    {
        return params.containsKey(key) ? (double)MathHelper.parseIntWithDefault(params.get(key), MathHelper.floor_double(defaultD)) + (offset ? 0.5D : 0.0D) : defaultD;
    }
    ...
    public static Map<String, Integer> getScoreMap(Map<String, String> params)
    {
        ...
        for (String s : params.keySet())
        {
            ...
            {
                map.put(s.substring("score_".length()), Integer.valueOf(MathHelper.parseIntWithDefault(params.get(s), 1)));
            }
        }
