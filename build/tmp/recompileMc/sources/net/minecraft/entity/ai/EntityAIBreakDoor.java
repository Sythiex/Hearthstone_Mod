...
public class EntityAIBreakDoor extends EntityAIDoorInteract
{
    ...
    public boolean shouldExecute()
    {
        ...
        else if (!this.theEntity.worldObj.getGameRules().getBoolean("mobGriefing") || !this.theEntity.worldObj.getBlockState(this.doorPosition).getBlock().canEntityDestroy(this.theEntity.worldObj.getBlockState(this.doorPosition), this.theEntity.worldObj, this.doorPosition, this.theEntity) || !net.minecraftforge.event.ForgeEventFactory.onEntityDestroyBlock(this.theEntity, this.doorPosition, this.theEntity.worldObj.getBlockState(this.doorPosition)))
        {
            return false;
        }
        else
