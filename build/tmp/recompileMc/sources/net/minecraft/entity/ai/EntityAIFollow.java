...
public class EntityAIFollow extends EntityAIBase
{
    ...
    {
        List<EntityLiving> list = this.field_192372_a.worldObj.<EntityLiving>getEntitiesWithinAABB(EntityLiving.class, this.field_192372_a.getEntityBoundingBox().expandXyz((double)this.field_192380_i), this.field_192373_b);
