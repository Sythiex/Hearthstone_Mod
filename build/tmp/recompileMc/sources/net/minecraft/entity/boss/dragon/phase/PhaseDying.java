...
public class PhaseDying extends PhaseBase
{
    ...
    public void doClientRenderEffects()
    {
        if (this.time++ % 10 == 0)
        {
            ...
            this.dragon.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_HUGE, this.dragon.posX + (double)f, this.dragon.posY + 2.0D + (double)f1, this.dragon.posZ + (double)f2, 0.0D, 0.0D, 0.0D);
        }
    }
