...
public class EntityIllusionIllager extends EntitySpellcasterIllager implements IRangedAttackMob
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.worldObj.isRemote && this.isInvisible())
        {
            --this.field_193099_c;
            ...
            else
            {
                ...
                this.worldObj.playSound(this.posX, this.posY, this.posZ, SoundEvents.field_193788_dg, this.getSoundCategory(), 1.0F, 1.0F, false);
            }
        }
    }
    ...
    class AIBlindnessSpell extends EntitySpellcasterIllager.AIUseSpell
    {
        ...
        public boolean shouldExecute()
        {
            ...
            {
                return EntityIllusionIllager.this.worldObj.getDifficultyForLocation(new BlockPos(EntityIllusionIllager.this)).func_193845_a((float)EnumDifficulty.NORMAL.ordinal());
            }
        }
