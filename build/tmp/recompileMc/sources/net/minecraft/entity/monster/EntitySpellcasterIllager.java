...
public abstract class EntitySpellcasterIllager extends AbstractIllager
{
    ...
    {
        return !this.worldObj.isRemote ? this.field_193089_bx : EntitySpellcasterIllager.SpellType.func_193337_a(((Byte)this.dataManager.get(field_193088_c)).byteValue());
    }
    ...
    public void onUpdate()
    {
        ...
        if (this.worldObj.isRemote && this.func_193082_dl())
        {
            ...
            this.worldObj.spawnParticle(EnumParticleTypes.SPELL_MOB, this.posX + (double)f1 * 0.6D, this.posY + 1.8D, this.posZ + (double)f2 * 0.6D, d0, d1, d2);
            this.worldObj.spawnParticle(EnumParticleTypes.SPELL_MOB, this.posX - (double)f1 * 0.6D, this.posY + 1.8D, this.posZ - (double)f2 * 0.6D, d0, d1, d2);
        }
    }
