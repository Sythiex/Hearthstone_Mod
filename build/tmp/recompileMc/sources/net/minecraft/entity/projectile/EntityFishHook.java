    ...
    public int handleHookRetraction()
    {
        if (!this.worldObj.isRemote && this.angler != null)
        {
            ...
            else if (this.ticksCatchable > 0)
            {
                ...
                List<ItemStack> result = this.worldObj.getLootTableManager().getLootTableFromLocation(LootTableList.GAMEPLAY_FISHING).generateLootForPools(this.rand, lootcontext$builder.build());
