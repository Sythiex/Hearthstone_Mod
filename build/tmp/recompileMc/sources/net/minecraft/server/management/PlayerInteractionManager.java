...
public class PlayerInteractionManager
{
    ...
    public void updateBlockRemoving()
    {
        ...
        if (this.receivedFinishDiggingPacket)
        {
            ...
            if (iblockstate.getBlock().isAir(iblockstate, theWorld, delayedDestroyPos))
            {
        ...
        else if (this.isDestroyingBlock)
        {
            ...
            if (iblockstate1.getBlock().isAir(iblockstate1, theWorld, destroyPos))
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (!itemstack1.func_190926_b())
                    {
                        ...
                        if (itemstack1.func_190926_b()) net.minecraftforge.event.ForgeEventFactory.onPlayerDestroyItem(this.thisPlayerMP, itemstack2, EnumHand.MAIN_HAND);
                    }
    ...
    public EnumActionResult processRightClickBlock(EntityPlayer player, World worldIn, ItemStack stack, EnumHand hand, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            boolean bypass = stack.func_190926_b() || stack.getItem().doesSneakBypassUse(stack, worldIn, pos, player);
            ...
            else
            {
                ...
                else
                {
                    if (result != EnumActionResult.SUCCESS && event.getUseItem() != net.minecraftforge.fml.common.eventhandler.Event.Result.DENY
                        ...
                        if (stack.func_190926_b()) net.minecraftforge.event.ForgeEventFactory.onPlayerDestroyItem(player, copyBeforeUse, hand);
                    } return result;
                }
            }
        }
