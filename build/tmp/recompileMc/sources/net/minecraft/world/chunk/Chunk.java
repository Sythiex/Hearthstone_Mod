...
public class Chunk
{
    ...
    private int getBlockLightOpacity(int x, int y, int z)
    {
        ...
        return !isChunkLoaded ? state.getLightOpacity() : state.getLightOpacity(worldObj, new BlockPos(this.xPosition << 4 | x & 15, y, this.zPosition << 4 | z & 15));
    }
    ...
    public void addEntity(Entity entityIn)
    {
        ...
        {
            LOGGER.warn("Wrong location! ({}, {}) should be ({}, {}), {}", Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(this.xPosition), Integer.valueOf(this.zPosition), entityIn);
            entityIn.setDead();
        }
    ...
    private void logCascadingWorldGeneration()
    {
        ...
        if (activeModContainer == null) // vanilla minecraft has problems too (MC-114332), log it at a quieter level.
            net.minecraftforge.fml.common.FMLLog.log.debug(format, "Minecraft", this.xPosition, this.zPosition, this.worldObj.provider.getDimension());
        else
            net.minecraftforge.fml.common.FMLLog.log.warn(format, activeModContainer.getName(), this.xPosition, this.zPosition, this.worldObj.provider.getDimension());
    }
}