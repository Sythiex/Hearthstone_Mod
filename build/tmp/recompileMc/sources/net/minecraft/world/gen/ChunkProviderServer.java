...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    public Chunk loadChunk(int x, int z, Runnable runnable)
    {
        ...
        if (chunk == null)
        {
            ...
            {
                if (!loadingChunks.add(pos)) net.minecraftforge.fml.common.FMLLog.bigWarning("There is an attempt to load a chunk ({},{}) in dimension {} that is already being loaded. This will cause weird chunk breakages.", x, z, this.worldObj.provider.getDimension());
