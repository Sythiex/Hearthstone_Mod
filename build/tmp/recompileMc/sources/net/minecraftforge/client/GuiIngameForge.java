...
public class GuiIngameForge extends GuiIngame
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        {
            renderVignette(mc.thePlayer.getBrightness(), res);
        }
        else
        {
    ...
    private void renderHelmet(ScaledResolution res, float partialTicks)
    {
        ...
        if (this.mc.gameSettings.thirdPersonView == 0 && !itemstack.func_190926_b())
        {
            ...
            {
                item.renderHelmetOverlay(itemstack, mc.thePlayer, res, partialTicks);
            }
        }
