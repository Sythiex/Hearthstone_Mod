    ...
    public void work()
    {
        ...
        if (next != null)
        {
            ...
            if (world == null)
            {
                ...
                if (world == null)
                {
                    listener.addChatMessage(new TextComponentTranslation("commands.forge.gen.dim_fail", dim));
                    queue.clear();
                    return;
                }
            }
            ...
            {
                listener.addChatMessage(new TextComponentTranslation("commands.forge.gen.progress", total - queue.size(), total));
                lastNotification = 0;
            }
            ...
            {
                PlayerChunkMapEntry watchers = world.getPlayerChunkMap().getEntry(chunk.xPosition, chunk.zPosition);
        ...
        if (queue.size() == 0)
        {
            listener.addChatMessage(new TextComponentTranslation("commands.forge.gen.complete", genned, total, dim));
